...
class DashboardScreenViewModel(private val stepTracker: StepTracker, private val appDatabase: AppDatabase) : ViewModel() {
                ...
                return object : ViewModelProvider.Factory {
                    ...
                    override fun <T : ViewModel> create(modelClass: Class<T>): T {
                        if (modelClass.isAssignableFrom(DashboardScreenViewModel::class.java)) {
                            ...
                            return DashboardScreenViewModel(stepTracker, appDatabase) as T
                        }
